...
<div class="container">
      ...
      <div class="row">
        <div class="col-sm-12 ">
            <div class="col-sm-2 offset-sm-10">
                <a class="btn btn-xs btn-success" href="{{ route('division.index') }}"> Go Back To Division</a>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <form method="post" class="form-control" action="{{route('division.store')}}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input id="name" type="text" class="form-control{{ $errors->has('Dname') ? ' is-invalid' : '' }}" 
                               name="Dname" value="{{ old('Dname') }}"  autofocus>
